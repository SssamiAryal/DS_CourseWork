...
broadband_performance_raw = read_csv(
  "Coursework_DS_Samir_Nath_Arjyal/Obtained data /InternetSpeed/201805_fixed_pc_performance_r03.csv"
)

broadband_clean <- broadband_performance_raw %>%
  rename(
    postcode = postcode,
...
write_csv(broadband_postcode_summary,"./Coursework_DS_Samir_Nath_Arjyal/Cleaned data /broadbandSpeed_performan.csv")
