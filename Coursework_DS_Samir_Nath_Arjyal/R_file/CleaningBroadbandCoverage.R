# =============================================================================
# Broadband Coverage Data Cleaning Script
# This script processes the large broadband coverage file
# =============================================================================
...
coverage_file <- file.path(base_path, "Obtained data /InternetSpeed/201809_fixed_pc_coverage_r01.csv")
...
write_csv(coverage_clean, file.path(base_path, "Cleaned data /broadband_coverage_cleaned.csv"))
...
write_csv(coverage_summary, file.path(base_path, "Cleaned data /broadband_coverage_summary.csv"))
