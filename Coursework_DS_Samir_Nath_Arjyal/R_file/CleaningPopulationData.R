...
write_csv(population_clean, file.path(base_path, "Cleaned data /population_cleaned.csv"))
write_csv(population_by_region, file.path(base_path, "Cleaned data /population_by_region.csv"))
write_csv(population_by_district, file.path(base_path, "Cleaned data /population_by_district.csv"))
write_csv(population_by_area, file.path(base_path, "Cleaned data /population_by_area.csv"))
