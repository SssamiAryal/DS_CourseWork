...
house_prices_2022 <- read_csv(file.path(base_path, "Cleaned data /cleaned_house_prices_2022.csv"), show_col_types = FALSE)
house_prices_2023 <- read_csv(file.path(base_path, "Cleaned data /cleaned_house_prices_2023.csv"), show_col_types = FALSE)
house_prices_2024 <- read_csv(file.path(base_path, "Cleaned data /cleaned_house_prices_2024.csv"), show_col_types = FALSE)
...
broadband_performance <- read_csv(file.path(base_path, "Cleaned data /broadbandSpeed_performance.csv"), show_col_types = FALSE)
...
write_csv(recommendation_data, file.path(base_path, "Cleaned data/recommendation_full_scores.csv"))

# Save top 10
write_csv(head(recommendation_data, 10), file.path(base_path, "Cleaned data /recommendation_top10.csv"))

# Save top 3
write_csv(head(recommendation_data, 3), file.path(base_path, "Cleaned data /recommendation_top3.csv"))

# Save regional comparison
write_csv(regional_comparison, file.path(base_path, "Cleaned data /regional_comparison.csv"))
